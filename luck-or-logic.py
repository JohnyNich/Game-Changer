...
while True:
	...
	if game == "blackjack":
		...
		word_by_word("Roulette is a game, typicaly played with a wheel with where you must either bet on black or white.")
		word_by_word("Let's begin. You will start with a score of 50")
		roulette.score = 50
	elif game == "exit":
		sys.exit()
	elif game == "games":
